...
public class Example13Federate
{
	...
	public void runFederate( String federateName ) throws RTIexception
	{
		...
		try
		{
			...
			log( "Utworzono federacj�" );
		}
		catch( FederationExecutionAlreadyExists exists )
		{
			log( "Nie utworzono federacji, poniewa� istnieje" );
		}
		...
		log( "Do��czono federata do federacji: " + federateName );
		...
		log( "Osi�gni�to punkt synchronizacji " +READY_TO_RUN+ ", oczekiwanie na federacj�..." );
		...
		publishAndSubscribe();
		log( "RTI wie, �e federat jest gotowy na subskrybcj� i federacj�" );
		...
		for( int i = 0; i < ITERATIONS; i++ )
		{
			...
			// 9.2 send an interaction
			sendInteraction();
			log( "Wys�ano interakc� " + i+"/"+ ITERATIONS);
		...
		log( "Usuni�cie obiektu, handle=" + objectHandle );

		////////////////////////////////////
		// 11. resign from the federation //
		////////////////////////////////////
		rtiamb.resignFederationExecution( ResignAction.NO_ACTION );
		log( "Rejestracja z federacji" );
	 ...
	 * handle. We can only delete obj we created, or for which we own the
	...
	public static void main( String[] args )
	{
		...
		//String federateName2 = "exampleFederate2";
		if( args.length != 0 )
		{
			federateName = args[0];
		}
		...
		try
		{
			...
			//new Example13Federate().runFederate( federateName2 );
		}
